...
This document contains a full list of all 958 skills available to the agent. For automated use, see [all_skills_inventory.json](./all_skills_inventory.json).

## Navigation

[ 0 ](#0) [ 1 ](#1) [ 2 ](#2) [ 3 ](#3) [ A ](#a) [ B ](#b) [ C ](#c) [ D ](#d) [ E ](#e) [ F ](#f) [ G ](#g) [ H ](#h) [ I ](#i) [ J ](#j) [ K ](#k) [ L ](#l) [ M ](#m) [ N ](#n) [ O ](#o) [ P ](#p) [ Q ](#q) [ R ](#r) [ S ](#s) [ T ](#t) [ U ](#u) [ V ](#v) [ W ](#w) [ X ](#x) [ Y ](#y) [ Z ](#z) 
...
| **headless-scraping** | "Automated data extraction and web performance monitoring using headless browsers (Playwright, Puppeteer, Selenium). Expert in bypass techniques, data parsing, and high-scale scraping architectures." |
